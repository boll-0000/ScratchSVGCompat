...
GTK のインストールが面倒な場合は、`*.py` 版ではなく、GTK を含めて配布された環境での利用をお勧めします。
...
選択してドラッグするか、選択した状態で上下左右キーを一度押してから元に戻すと修正されることがあります。ほとんどの場合はこれで修正されます。
...
If GTK is not installed, the Python version may require additional setup depending on your environment.
